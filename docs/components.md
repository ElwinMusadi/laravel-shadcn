...
| --- | --- |
| <code>x-app.shell</code> | Shell aplikasi, data navigation default, sidebar desktop, header, main landmark, toast, dan <code>@livewireScripts</code>. |
...
| <code>x-app.sidebar</code> | Sidebar Dashboard-01 desktop atau mobile, application brand link, navigasi, dan user menu. |
...
| <code>x-app.brand</code> | Identitas aplikasi yang menaut ke Dashboard; varian sidebar bukan pemilih workspace. |
...
<code>x-app.shell</code> menerima <code>title</code>, <code>description</code>, <code>breadcrumbs</code>, <code>showPageHeader</code>, dan <code>navigation</code>.
